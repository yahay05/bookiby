...
namespace Bookiby.Infrastructure.Migrations
{
    ...
    [Migration("20250612201430_Add_Relation_between_R_and_P")]
    partial class Add_Relation_between_R_and_P
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookiby.Domain.Apartments.Apartment", b =>
                {
            ...
            modelBuilder.Entity("Bookiby.Domain.Bookings.Booking", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookiby.Domain.Reviews.Review", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookiby.Domain.Users.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Bookiby.Domain.Users.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Bookiby.Domain.Users.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Bookiby.Domain.Users.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookiby.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("Bookiby.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookiby.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<string>("ApartmentId")
                                .HasColumnType("text")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookiby.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<string>("ApartmentId")
                                .HasColumnType("text")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookiby.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("Bookiby.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("Bookiby.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Bookiby.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookiby.Domain.Shared.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<string>("BookingId")
                                .HasColumnType("text")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookiby.Domain.Shared.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<string>("BookingId")
                                .HasColumnType("text")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookiby.Domain.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<string>("BookingId")
                                .HasColumnType("text")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookiby.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("Bookiby.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Bookiby.Domain.Users.RolePermission", b =>
                {
                    b.HasOne("Bookiby.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("Bookiby.Domain.Users.Role", null)
                        .WithMany()
